...
import com.valueresearch.pages.ContactUsVrsaPage;
...
public class ContactUsVrsaTest extends BaseTest {
    ...
    public void CU_001_OpenContactUsFromHub() {
        ...
        ContactUsVrsaPage page = new ContactUsVrsaPage(driver);
    ...
    @Test(priority = 2, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_002_VerifyTitleAndMessageBox() {
        ...
        getContactUsVrsaPage().verifyTitleAndMessageBox();
        markPassed("CU_002 - Title and message box validated successfully");
    }

    @Test(priority = 3, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_003_VerifyChooseFileAndEscalationMatrixStaticText() {
        ...
        getContactUsVrsaPage().verifyChooseFileAndEscalationMatrix();
        markPassed("CU_003 - Choose File and Escalation Matrix static text validated successfully");
    }

    @Test(priority = 4, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_004_VerifyPhoneAndWorkingHours() {
        ...
        getContactUsVrsaPage().verifyPhoneAndWorkingHours();
        markPassed("CU_004 - Phone and working hours validated successfully");
    }

    @Test(priority = 5, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_005_VerifyPostalAddress() {
        ...
        getContactUsVrsaPage().verifyPostalAddress();
        markPassed("CU_005 - Postal address validated successfully");
    }

    @Test(priority = 6, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_006_VerifyGrievanceAndScoresInfo() {
        ...
        getContactUsVrsaPage().verifyGrievanceAndScoresInfo();
        markPassed("CU_006 - Grievance email and SCORES link validated successfully");
    }

    @Test(priority = 7, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_007_VerifyAndroidAndIosAppLinksStaticText() {
        ...
        getContactUsVrsaPage().verifyAppLinks();
        markPassed("CU_007 - Android and iOS App static link text validated successfully");
    }

    @Test(priority = 8, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_008_VerifySubmitButtonStaticText() {
        ...
        getContactUsVrsaPage().verifySubmitButton();
        markPassed("CU_008 - Submit button text validated successfully");
    }

    @Test(priority = 9, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_009_VerifyContactUsScreenStability() {
        ...
        getContactUsVrsaPage().verifyContactUsScreenStability();
        markPassed("CU_009 - Contact Us screen stability validated successfully");
    }

    @Test(priority = 10, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_010_VerifyPositiveMessageTyping() {
        ...
        getContactUsVrsaPage().verifyMessageTyping();
        markPassed("CU_010 - Positive message typing validated successfully");
    }

    @Test(priority = 11, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_011_VerifySpecialCharacterMessageTyping() {
        ...
        getContactUsVrsaPage().verifySpecialCharacterMessageTyping();
        markPassed("CU_011 - Special character message typing validated successfully");
    }

    @Test(priority = 12, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_012_VerifyInputCanBeCleared() {
        ...
        getContactUsVrsaPage().verifyInputCanBeCleared();
        markPassed("CU_012 - Message input clear validation passed");
    }

    @Test(priority = 13, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_013_VerifyEmptySubmitNegativeValidation() {
        ...
        getContactUsVrsaPage().verifyEmptySubmitValidation();
        markPassed("CU_013 - Empty submit negative validation passed");
    }

    @Test(priority = 14, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_014_VerifyWhitespaceSubmitNegativeValidation() {
        ...
        getContactUsVrsaPage().verifyWhitespaceSubmitValidation();
        markPassed("CU_014 - Whitespace submit negative validation passed");
    }

    @Test(priority = 15, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_015_VerifySubmitButtonStateForEmptyMessage() {
        ...
        getContactUsVrsaPage().verifySubmitButtonStateForEmptyMessage();
        markPassed("CU_015 - Submit button state logged successfully");
    }

    @Test(priority = 16, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_016_VerifyChooseFileFunctionalTap() {
        ...
        getContactUsVrsaPage().verifyChooseFileFunctionalTap();
        markPassed("CU_016 - Choose File functional tap validated successfully");
    }

    @Test(priority = 17, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_017_VerifyEscalationMatrixFunctionalTap() {
        ...
        getContactUsVrsaPage().verifyEscalationMatrixFunctionalTap();
        markPassed("CU_017 - Escalation Matrix functional tap validated successfully");
    }

    @Test(priority = 18, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_018_VerifyPhoneFunctionalTap() {
        ...
        getContactUsVrsaPage().verifyPhoneFunctionalTap();
        markPassed("CU_018 - Phone functional tap validated successfully");
    }

    @Test(priority = 19, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_019_VerifyGrievanceEmailFunctionalTap() {
        ...
        getContactUsVrsaPage().verifyGrievanceEmailFunctionalTap();
        markPassed("CU_019 - Grievance email functional tap validated successfully");
    }

    @Test(priority = 20, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_020_VerifyScoresLinkFunctionalTap() {
        ...
        getContactUsVrsaPage().verifyScoresLinkFunctionalTap();
        markPassed("CU_020 - SEBI SCORES functional tap validated successfully");
    }

    @Test(priority = 21, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_021_VerifyAndroidAppFunctionalTap() {
        ...
        getContactUsVrsaPage().verifyAndroidAppFunctionalTap();
        markPassed("CU_021 - Android App functional tap validated successfully");
    }

    @Test(priority = 22, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_022_VerifyIosAppFunctionalTap() {
        ...
        getContactUsVrsaPage().verifyIosAppFunctionalTap();
        markPassed("CU_022 - iOS App functional tap validated successfully");
    }

    @Test(priority = 23, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_024_VerifyStockAdvisorEscalationMatrixPdf() {
        createExtentTest(
                "CU_024",
                "Verify Stock Advisor Escalation Matrix PDF",
                "Select Value Research Stock Advisor from Contact Us dropdown, open Escalation Matrix, "
                        + "and fail if the Fund Advisor/VRFA PDF is shown instead of the Stock Advisor PDF"
        );

        ReportLogger.step("Starting test case: CU_024 - Verify Stock Advisor Escalation Matrix PDF");
        getContactUsVrsaPage().verifyStockAdvisorEscalationMatrixPdf();
        markPassed("CU_024 - Stock Advisor Escalation Matrix PDF validated successfully");
    }


    @Test(priority = 24, dependsOnMethods = "CU_001_OpenContactUsFromHub", alwaysRun = true)
    public void CU_023_VerifyBackNavigationToHub() {
        ...
        getContactUsVrsaPage().verifyBackNavigationToHub();
        markPassed("CU_023 - Back navigation to Hub validated successfully");
    }

    private ContactUsVrsaPage getContactUsVrsaPage() {
        ContactUsVrsaPage page = new ContactUsVrsaPage(driver);

        if (!contactUsOpened || !page.isContactUsPageVisible()) {
            ReportLogger.step("Contact Us VRSA page is not active. Recovering before validation.");
    ...
    private void createExtentTest(String caseId, String title, String validation) {
        ...
        test.info("Module: Contact Us VRSA<br>"
                + "Case ID: " + caseId + "<br>"
